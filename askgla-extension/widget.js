/*
 * AskGLA chat widget — extension version.
 * Exposes window.__askglaInit(apiBase, dept) called by content.js.
 */

window.__askglaInit = function (API_BASE, DEPARTMENT) {
  "use strict";
  ...
  function buildStyles() {
    var TOP      = "#0F3D2E";  // header background
    var FOOT     = "#1A5C42";  // input bar background
    var BOT_BG   = "#D1FAE5";  // bot bubbles + pills
    var USER_BG  = "#FEF3C7";  // user bubbles
    var SEND_CLR = "#F59E0B";  // send button
    var CHAT_BG  = "#F5F5F5";  // main chat area
    var INPUT_BG = "#FFFFFF";  // textarea
    ...
    return [
      ...
      // Message rows — column so timestamp goes below bubble
